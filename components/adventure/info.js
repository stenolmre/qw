...
export default function Info({ adventure, id }) {
  ...
  return <div className="adventure-content">
    ...
    <div className="adventure-first-info">
      ...
      <p className="txt-js">{userLanguage ? adventure.description : adventure.kirjeldus}</p>
      ...
      <Social userLanguage={userLanguage} eng="Share with friends" est="Jaga Sõpradega">
        <div className="adventure-social-share">
          ...
          <a rel="nofollow noopener" href={`fb-messenger://share/?link=https://stenolmre.com/adventures/${adventure._id}`}><i className="fab fa-facebook-messenger" style={{ color: '#0078FF' }}/></a>
