...
export default function Adventures() {
  ...
  return <Fragment>
    <Head title={userLanguage ? "North Season - Adventures" : "North Season - Elamusmatkad"} description={userLanguage ? landingeng : landingest} image="https://etreeningud.ee/media/images/stenolmre/OG_IMG_2946.jpg" url="https://stenolmre.com/adventures" />
    <Container>
...
function Texts({ router, userLanguage }) {
  return <Fragment>
    ...
    {
      router.query.category === 'all' && <p className="adventure-intro">{userLanguage ? 'Moments worth remembering for a lifetime. It can be snowshoeing in the deep snow where others can’t go. It can be e-biking in extreme winter in places you wouldn’t dare cycling. It can be a simple day of hiking across fells to enjoy the magical colours of Lappish Autumn (ruska). It can be summer backpacking trip with amazing camp nights by the fire or you can take part in our stunning bike tours and before you know it, you have conquered the most northern place in Europe with nothing but bicycle. We can give you magical experiences through the adventures we know to be exceptional.' : 'Meeldejäävad hetked kogu eluks! Looduses matkamine sobib igasse aastaaega. Talvel pääseb liikuma räätsade või suuskadega, muul ajal jalgsi või rattaga. Meie elamusmatkade valikust leiad matku, mis sobivad nii algajatele kui ka kogenud seiklejatele. Tule tee räätsadega esimesed jäljed puutumatul lumel või ühine meiega pikematel rattaretkedel läbi põhjamaa karge ilu. Meie matkast võib saada Sinu suurte seikluste algus!'}</p>
    }
    {
