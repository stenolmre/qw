...
function Texts({ router, userLanguage }) {
  return <Fragment>
    ...
    {
      router.query.category === 'all' && <p className="adventure-intro">{userLanguage ? 'Adventures worth remembering for lifetime. It can be snowshoeing in the deep snow where others can’t go. It can be e-biking in extreme winter in places you wouldn’t dare cycling. It can be a simple day of hiking across fells to enjoy the magical colours of Lappish ruska. It can be summer backpacking trip with amazing camp nights by the fire or you can take part in our stunning bike tours and before you know it, you have conquered the most northern place in Europe with nothing but bicycle. We can give you magical experiences through the adventures we know to be exceptional.' : 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.'}</p>
    }
    {
